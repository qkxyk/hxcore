...
namespace HXCloud.APIV2.Controllers
{
    ...
    public class DeviceImageController : ControllerBase
    {
        ...
        [HttpPut]
        [TypeFilter(typeof(DeviceActionFilterAttribute))]
        public async Task<ActionResult<BaseResponse>> UpdateDeviceImage(string GroupId, string DeviceSn, DeviceImageUpdateDto req)
        {
            string account = User.Claims.FirstOrDefault(a => a.Type == "Account").Value;
        ...
        [HttpDelete("{Id}")]
        [TypeFilter(typeof(DeviceActionFilterAttribute))]
        public async Task<ActionResult<BaseResponse>> DeleteDeviceImage(string GroupId, string DeviceSn, int Id)
        {
            string account = User.Claims.FirstOrDefault(a => a.Type == "Account").Value;
        ...
        public async Task<ActionResult<BaseResponse>> GetDeviceImage(string GroupId, string DeviceSn, int Id)
        {
        ...
        [HttpGet]
        [TypeFilter(typeof(DeviceViewActionFilterAttribute))]
        public async Task<ActionResult<BaseResponse>> GetDeviceImages(string GroupId, string DeviceSn)
        {
